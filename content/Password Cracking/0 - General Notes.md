...
`hashcat -m 0 -a 6 ./hashfiles/svuHashes.txt svupws.txt ?d?d    `
?d appends a digit to each
...
`$ cut -d: -f 2- ~/.local/share/hahscat/hashcat.potfile
...
## hashes.com
## ophcrack
use ophcrack - download rainbow tables first
